...
func (c *heartBeatServiceClient) AlivePing(ctx context.Context, in *AlivePingRequest, opts ...grpc.CallOption) (*AlivePingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/register.HeartBeatService/AlivePing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeartBeatService_AlivePing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register.HeartBeatService/AlivePing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var HeartBeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "register.HeartBeatService",
